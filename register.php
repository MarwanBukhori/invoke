                ...
                <div class="uk-width-expand@m">
                  <div class="section-banner__breadcrumb">
                    <ul class="uk-breadcrumb">
                      ...
                      <li><span>Restaurants Register</span></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <form action="<?php echo base_url(); ?>registerMe" method="post">
            <div class="uk-first-column">
                <div class="form-group has-feedback">
                    <input type="text" class="uk-input form-control" placeholder="Name" name="name" required />
          ...
          <div class="uk-grid-margin uk-first-column">
            <div class="form-check">
                <input class="form-check-input" value="2" type="radio" name="user_role" id="user_role_customer">
                <label class="form-check-label" for="user_role_customer">
                    Customer
                </label>
                </div>
                <div class="form-check">
                <input class="form-check-input" value="1" type="radio" name="user_role" id="user_role_restaurant" >
                <label class="form-check-label" for="user_role_restaurant">
                    Restaurant
                </label>
            </div>
          </div>
