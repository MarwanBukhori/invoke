...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['restaurantInfo'] = $this->restaurant_model->getrestaurantInfo( $this->session->userdata('userId'));
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Restaurant System : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Restaurant System : Add New User';
    ...
    function modifyUser($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Restaurant System : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Restaurant System : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Restaurant System : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Restaurant System : My Profile' : 'Restaurant System : Change Password';
